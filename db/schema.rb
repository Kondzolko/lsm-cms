...
ActiveRecord::Schema.define(version: 2020_09_25_175759) do
  ...
  create_table "deligated_authorities", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["confirmation_token"], name: "index_deligated_authorities_on_confirmation_token", unique: true
  ...
  create_table "underwriters", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["confirmation_token"], name: "index_underwriters_on_confirmation_token", unique: true
    t.index ["email"], name: "index_underwriters_on_email", unique: true
    t.index ["reset_password_token"], name: "index_underwriters_on_reset_password_token", unique: true
    t.index ["unlock_token"], name: "index_underwriters_on_unlock_token", unique: true
  end
